...
const Weather = () => {
    ...
    return (
        <div className={`${rootClass}`}>
            ...
            <div className="card"> 
                <h2 className="value">{isC ? `${isWeather.main?.temp.toFixed(0)}° ` : `${(isWeather.main?.temp*1.8 + 32).toFixed(0)}° `} <span><img src={`./public/iconos/${icons[isWeather.weather?.[0].main]}`} alt="" /> </span> 
                </h2>
